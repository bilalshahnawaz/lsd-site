...
export default function Header() {
  return (
    <header className="z-[999] relative">
        ...
        >
            <ul 
                className="flex w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-white sm:w-[initial] sm:flex-nowrap sm:gap-5"
            >
                {
                    links.map(link => (
                        <motion.li 
                        ...
                        >
                            <Link 
                                className="flex w-full items-center justify-center px-3 py-3 hover:text-gray-400" 
                                href={link.hash}
                            >
                                {link.name}
                            </Link>
